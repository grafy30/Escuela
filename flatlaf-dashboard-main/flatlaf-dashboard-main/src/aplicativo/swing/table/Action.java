...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new aplicativo.swing.Button();
        cmdDelete = new aplicativo.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicativo/icon/png/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicativo/icon/png/delete.png"))); // NOI18N
    ...
    private aplicativo.swing.Button cmdDelete;
    private aplicativo.swing.Button cmdEdit;
